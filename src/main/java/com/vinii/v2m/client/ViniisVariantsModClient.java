...
public class ViniisVariantsModClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        // Entities
        EntityRenderers.register(ModEntities.ICID, IcidRenderer::new);
        EntityRenderers.register(ModEntities.MUDDY_ZOMBIE, MuddyZombieRenderer::new);
        EntityRenderers.register(ModEntities.SOUL_SKELETON, SoulSkeletonRenderer::new);
        EntityRenderers.register(ModEntities.PALE_SNOW_GOLEM, PaleSnowGolemRenderer::new);
        EntityRenderers.register(ModEntities.WARPED_ENDERMAN, WarpedEndermanRenderer::new);
        EntityRenderers.register(ModEntities.FROZEN_GUARDIAN, FrozenGuardianRenderer::new);
        EntityRenderers.register(ModEntities.SOUL_BLAZE, SoulBlazeRenderer::new);
        ...
        // Block entities
        BlockEntityRenderers.register(ModBlockEntities.MOD_CHEST_BLOCK_ENTITY, ChestRenderer::new);
        BlockEntityRenderers.register(ModBlockEntities.MOD_TRAPPED_CHEST_BLOCK_ENTITY, ChestRenderer::new);
    }
}
