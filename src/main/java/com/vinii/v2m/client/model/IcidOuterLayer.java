...
public class IcidOuterLayer extends RenderLayer<ZombieRenderState, DrownedModel> {
    private static final Identifier ICID_OUTER_LAYER_LOCATION = Identifier.fromNamespaceAndPath(ViniisVariantsMod.MOD_ID,
        "textures/entity/zombie/icid_outer_layer.png");
    private static final Identifier BABY_ICID_OUTER_LAYER_LOCATION = Identifier.fromNamespaceAndPath(ViniisVariantsMod.MOD_ID,
    ...
    public void submit(@NonNull PoseStack poseStack, @NonNull SubmitNodeCollector submitNodeCollector, int i, ZombieRenderState zombieRenderState, float f, float g) {
        ...
        Identifier layerLocation = zombieRenderState.isBaby ? BABY_ICID_OUTER_LAYER_LOCATION : ICID_OUTER_LAYER_LOCATION;
